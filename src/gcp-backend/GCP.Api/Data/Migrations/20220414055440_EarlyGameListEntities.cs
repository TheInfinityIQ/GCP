		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					joined_game_lists_id = table.Column<int>(type: "integer", nullable: false)
				},
				constraints: table =>
				{
					table.PrimaryKey("pk_game_list_user", x => new { x.game_list_id, x.user_id });
					table.ForeignKey(
						name: "fk_game_list_user_asp_net_users_user_id",
						column: x => x.user_id,
						principalTable: "user",
						principalColumn: "id",
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						...
						onDelete: ReferentialAction.Cascade);
					table.ForeignKey(
						name: "fk_game_list_user_game_list_joined_game_lists_id",
						column: x => x.joined_game_lists_id,
						principalTable: "game_list",
						principalColumn: "id",
						onDelete: ReferentialAction.Cascade);
				});
			...
			migrationBuilder.CreateIndex(
				name: "ix_game_list_user_joined_game_lists_id",
				table: "game_list_user",
				column: "joined_game_lists_id");
